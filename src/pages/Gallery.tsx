...
const galleryImages = [
  ...
  { id: 4, src: 'https://res.cloudinary.com/dcvipikha/image/upload/f_auto,q_auto/v1770786745/doctora_con_utero_hf6ufx.jpg', loading: "lazy", category: 'ultrasounds', alt: 'Doctora Ekaterina' },
  { id: 5, src: 'https://res.cloudinary.com/dcvipikha/image/upload/w_550,h_450,c_fill,g_face,f_auto,q_auto/v1770786745/doctora_ekaterina_sjbvon.jpg', loading: "lazy", category: 'patients', alt: 'Doctora Ekaterina' },
  { id: 6, src: 'https://res.cloudinary.com/dcvipikha/image/upload/f_auto,q_auto/v1770786745/puerta_consultorio_vvevmw.jpg', loading: "lazy", category: 'office', alt: 'Consultorio' },
  { id: 7, src: 'https://res.cloudinary.com/dcvipikha/image/upload/f_auto,q_auto/v1771106361/equipo_medico_abij92.jpg', loading: "lazy", category: 'equipment', alt: 'Equipos de diagnóstico' },
  { id: 8, src: 'https://res.cloudinary.com/dcvipikha/image/upload/f_auto,q_auto/v1771469921/T_de_cobre_casisq.jpg', loading: "lazy", category: 'equipment', alt: 'T de cobre' },
  ...
  { id: 14, src: 'https://res.cloudinary.com/dcvipikha/image/upload/f_auto,q_auto/v1771469859/ultrasonido2_taeyi8.jpg', loading: "lazy", category: 'ultrasounds', alt: 'Ultrasonido' },
  { id: 15, src: 'https://res.cloudinary.com/dcvipikha/image/upload/f_auto,q_auto/v1771469859/ultrasonido1_bczluq.jpg', loading: "lazy", category: 'ultrasounds', alt: 'Ultrasonido' },
  { id: 16, src: 'https://res.cloudinary.com/dcvipikha/image/upload/f_auto,q_auto/v1771469858/ultrasonido3_jnws6f.jpg', loading: "lazy", category: 'ultrasounds', alt: 'Ultrasonido' },
  { id: 17, src: 'https://res.cloudinary.com/dcvipikha/image/upload/f_auto,q_auto/v1771469858/ultrasonido7_wvmvm2.jpg', loading: "lazy", category: 'ultrasounds', alt: 'Ultrasonido' },
  { id: 18, src: 'https://res.cloudinary.com/dcvipikha/image/upload/f_auto,q_auto/v1771469858/ultrasonido4_u4vou0.jpg', loading: "lazy", category: 'ultrasounds', alt: 'Ultrasonido' },
  { id: 19, src: 'https://res.cloudinary.com/dcvipikha/image/upload/f_auto,q_auto/v1771469858/ultrasonido8_vl0bgi.jpg', loading: "lazy", category: 'ultrasounds', alt: 'Ultrasonido' },
  { id: 20, src: 'https://res.cloudinary.com/dcvipikha/image/upload/f_auto,q_auto/v1771469858/ultrasonido9_loteai.jpg', loading: "lazy", category: 'ultrasounds', alt: 'Ultrasonido' },
  { id: 21, src: 'https://res.cloudinary.com/dcvipikha/image/upload/f_auto,q_auto/v1771469858/ultrasonido5_qggpxq.jpg', loading: "lazy", category: 'ultrasounds', alt: 'Ultrasonido' },
  { id: 22, src: 'https://res.cloudinary.com/dcvipikha/image/upload/f_auto,q_auto/v1771469858/ultrasonido6_rqrwvg.jpg', loading: "lazy", category: 'ultrasounds', alt: 'Ultrasonido' },
  { id: 23, src: 'https://images.unsplash.com/photo-1584515933487-779824d29309?w=600&h=400&fit=crop', loading: "lazy", category: 'patients', alt: 'Cuidado prenatal' },
];
